...
public class UbicacionGeograficaResource {
    ...
    private final UbicacionGeograficaService ubicacionGeograficaService;

    public UbicacionGeograficaResource(UbicacionGeograficaService ubicacionGeograficaService) {
        this.ubicacionGeograficaService = ubicacionGeograficaService;
    }

    @GET
    @Operation(summary = "Consultar de ubicaciones geográficas", description = "Retorna la listade ubicaciones geográficas.")
    @APIResponse(responseCode = "200", description = "Listado obtenido correctamente", content = @Content(mediaType = MediaType.APPLICATION_JSON, schema = @Schema(implementation = UbicacionGeograficaResponse[].class), examples = {
    ...
    @APIResponse(responseCode = "404", description = "No se encontraron ubicaciones geográficas para los criterios solicitados")
