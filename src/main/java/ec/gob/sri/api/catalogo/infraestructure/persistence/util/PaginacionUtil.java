...
public class PaginacionUtil {
    ...
    public static Sort crearOrdenamiento(String ordenarPor, String orden) {
        String campo = normalizarOrdenarPor(ordenarPor);
    ...
    /**
     * Calcula la página actual (base 1) a partir del índice de Panache (base 0)
     */
    public static int calcularPaginaActual(int paginaIndex) {
