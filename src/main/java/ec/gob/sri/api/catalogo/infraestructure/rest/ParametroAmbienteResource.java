...
public class ParametroAmbienteResource {
        ...
        private final GestionarParametroAmbiente gestionarParametro;
        private final ParametroAmbienteMapper mapper;

        public ParametroAmbienteResource(GestionarParametroAmbiente gestionarParametro, ParametroAmbienteMapper mapper) {
                this.gestionarParametro = gestionarParametro;
                this.mapper = mapper;
        }
